...
(defun all-the-same-p (row-or-col)
  (every (lambda (c) (eq c (aref row-or-col 0))) row-or-col))

(defun row (board row-num)
  (vector (aref board row-num 0) (aref board row-num 1) (aref board row-num 2)))

(defun column (board col-num)
  (vector (aref board 0 col-num) (aref board 1 col-num) (aref board 2 col-num)))
